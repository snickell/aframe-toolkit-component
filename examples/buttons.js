...
export default export default defineDreem.classDreem.class("$server/composition",function(requireDreemDreem, $ui$, button, radiobutton, screen, label, view, icon, cadgrid) {
