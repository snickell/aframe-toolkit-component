...
export default defineDreem.class.class("$server/composition",function(requireDreem, $ui$, checkbox, icon, button, drawer, label, view, screen, cadgrid, $widgets$, toolkit) {
