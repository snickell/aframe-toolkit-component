...
export default defineDreem.class('$ui/view', function($ui$, view, label, button, icon){
// The treeview control - classic treeview with expandable nodes.
	...
	export default defineDreem.class(this, 'foldbutton', button, function(){
		this.borderwidth = 0
		this.bold = false;
		this.fontsize = 14;
	...
	export default defineDreem.class(this, 'newitemheading', view, function(){
		this.borderwidth = 0;
		this.attributes = {
			folded: false,
			select: Config({type:Event}),
	...
	export default defineDreem.class(this, 'treeitem', view, function(){
	...
	export default defineDreem.class(this, 'treeline', view, function(){
