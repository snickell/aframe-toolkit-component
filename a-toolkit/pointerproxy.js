...
export default defineDreem.class('$system/base/pointer', function (requireDreem, exports) {
	...
	this.atConstructor = function(device, pointerEvtSrc) {		
		this.eventSrc = pointerEvtSrc;
		this.device = device
		...
		this.mousedown = function(e) {
			...
			this.eventSrc.removeEventListener('mousemove', this._mousehover)
			this.eventSrc.removeEventListener('mousedown', this._mousedown)
			this.eventSrc.addEventListener('mousemove', this._mousemove)
			this.eventSrc.addEventListener('mouseup', this._mouseup)
			this.eventSrc.addEventListener('contextmenu', this._mouseup)
		}
		this._mousedown = this.mousedown.bind(this)

		this.eventSrc.addEventListener('mousedown', this._mousedown)
		...
		this.mouseup = function(e) {
			...
			this.eventSrc.removeEventListener('mousemove', this._mousemove)
			this.eventSrc.removeEventListener('mouseup', this._mouseup)
			this.eventSrc.removeEventListener('contextmenu', this._mouseup)
			this.eventSrc.addEventListener('mousemove', this._mousehover)
			this.eventSrc.addEventListener('mousedown', this._mousedown)
		}
		...
		this.eventSrc.addEventListener('touchstart', this.touchstart.bind(this))
		...
		this.eventSrc.addEventListener('touchmove', this.touchmove.bind(this))
		...
		this.eventSrc.addEventListener('touchend', this.touchend.bind(this))
		this.eventSrc.addEventListener('touchcancel', this.touchend.bind(this))
		this.eventSrc.addEventListener('touchleave', this.touchend.bind(this))
		...
		/* this.eventSrc.addEventListener('wheel', function(e) {
			e.preventDefault()
